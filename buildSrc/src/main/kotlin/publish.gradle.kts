        ...
        publications {
            create<MavenPublication>("release") {
                ...
                pom {
                    ...
                    url.set("https://github.com/computr0n/app/")
                    ...
                    scm {
                        connection.set("scm:git:git://github.com/computr0n/app.git")
                        developerConnection.set("scm:git:ssh://github.com/computr0n/app.git")
                        url.set("https://github.com/computr0n/app/")
                    }
                    issueManagement {
                        system.set("GitHub Issues")
                        url.set("https://github.com/computr0n/app/issues")
                    }
                }
            }
        }
